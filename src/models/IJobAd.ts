// /src/models/IJobAd.ts

/**
 * Raw job ad model returned by the JobTech API.
 * Most fields are optional because the API may omit values.
 */
export interface IJobAd {
    ...
    schedule_type?: { id?: string; label?: string | null };
